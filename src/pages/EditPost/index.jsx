...
import { useUpdateDocument } from "../../hooks/useEdit";
      ...
      {post && (
        <>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <p className={styles.preview_title}>actual picture</p>
            <img
              clasname={styles.image_preview}
              src={post.image}
              alt={post.title}
            />
            <label>
            ...
            {!response.loading && (
              <Button className="btn" textbox="Create Post" />
            )}
            {response.loading && (
